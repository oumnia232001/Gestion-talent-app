  ...
  return <>
   ...
   <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
    ...
    <h1 className="text-7xl font-bold leading-none sm:text-6xl">
      ...
      <a rel="noopener noreferrer" href="http://localhost:3000/login" className="px-8 py-3 text-lg font-semibold rounded bg-blue-400 text-gray-50">Login</a>

	  
				<a rel="noopener noreferrer" href= "http://localhost:3000/register" className="px-8 py-3 text-lg font-semibold border rounded dark:border-gray-800">Register</a>
			</div>
		</div>
	</div>
...
///////////////////////
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="http://localhost:3000/" className="flex justify-center space-x-3 lg:justify-start">
				
			
			<img src="src/assets/FD.png" alt="" className="object-contain h-8 sm:h-10 lg:h-12 xl:h-14 2xl:h-16" />
  
				<span className="self-center text-2xl font-semibold">FD Solutions Careers</span>
			</a>
		</div>
